...
public class ReguralTIleTest {
    ...
    void addNeighbours(){
        ...
        assertEquals(tile1.getNeighbourTile().get(new Vector2d(2,0)).getPosition(),new Vector2d(2,0));
        assertEquals(tile1.getNeighbourTile().get(new Vector2d(2,1)).getPosition(),new Vector2d(2,1));
        ...
        assertEquals(tile1.getNeighbourTile().get(new Vector2d(2,0)).getPosition(),new Vector2d(2,0));
        assertEquals(tile1.getNeighbourTile().get(new Vector2d(2,1)).getPosition(),new Vector2d(2,1));
        assertEquals(tile1.getNeighbourTile().get(new Vector2d(2,2)).getPosition(),new Vector2d(2,2));
        assertEquals(tile1.getNeighbourTile().get(new Vector2d(1,1)).getPosition(),new Vector2d(1,1));
        assertEquals(tile1.getNeighbourTile().get(new Vector2d(1,0)).getPosition(),new Vector2d(1,0));
